...
html_title = "What Is Bitdefender Central? Securely Activate Your Subscription with a Keycard"

# Optional short title (e.g., for nav bar)
html_short_title = "Securely Activate Your Subscription with a Keycard"
